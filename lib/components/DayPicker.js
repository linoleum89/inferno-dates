...
var DayPicker = function (_Component) {
	...
	function DayPicker(props) {
		...
		_this.initializeDayPickerWidth = _this.initializeDayPickerWidth.bind(_this);
		...
		_this.setTransitionRef = _this.setTransitionRef.bind(_this);
		_this.closeKeyboardShortcutsPanel = _this.closeKeyboardShortcutsPanel.bind(_this);
		_this.adjustDayPickerHeight = _this.adjustDayPickerHeight.bind(_this);
		return _this;
	}
	...
	_createClass(DayPicker, [{
		...
		value: function setCalendarMonthGridRef(ref) {
			this.calendarMonthGrid = ref;
		}
	}, {
		key: 'setTransitionRef',
		value: function setTransitionRef(ref) {
		...
		value: function initializeDayPickerWidth() {
			if (this.calendarMonthGrid) {
				...
				var calendarMonthGridDOMNode = (0, _findDOMNode2.default)(this.calendarMonthGrid);
		...
		value: function adjustDayPickerHeight() {
			...
			if (this.transitionContainer) Array.prototype.forEach.call(this.transitionContainer.querySelectorAll('.CalendarMonth'), function (el) {
		...
		value: function render() {
			...
			return (0, _inferno.createVNode)(1, 'div', dayPickerClassNames, (0, _inferno.createComponentVNode)(2, _OutsideClickHandler2.default, {
				...
				children: [(0, _inferno.createVNode)(1, 'div', 'DayPicker__week-headers', weekHeaders, 0, {
					...
					'focusedDate': focusedDate,
					'phrases': phrases
				}, null, this.setCalendarMonthGridRef), verticalScrollable && this.renderNavigation()], 0, {
					'style': transitionContainerStyle
				}, null, this.setTransitionRef), !isTouch && (0, _inferno.createComponentVNode)(2, _DayPickerKeyboardShortcuts2.default, {
