...
var DateInput = function (_Component) {
  ...
  _createClass(DateInput, [{
    ...
    value: function render() {
      ...
      var screenReaderMessageId = 'DateInput__screen-reader-message-' + id;

      return (0, _inferno.createVNode)(1, 'div', (0, _classnames2.default)('DateInput', {
        'DateInput--with-caret': showCaret && focused,
        'DateInput--disabled': disabled
      }), [(0, _inferno.createVNode)(64, 'input', 'DateInput__input needsclick', null, 1, {
        ...
        _this2.inputRef = ref;
      }), screenReaderMessage && (0, _inferno.createVNode)(1, 'p', 'screen-reader-only', screenReaderMessage, 0, {
        'id': screenReaderMessageId
      }), (0, _inferno.createVNode)(1, 'div', (0, _classnames2.default)('DateInput__display-text', {
