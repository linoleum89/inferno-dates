...
describe('DayPickerRangeController', () => {
  ...
  describe('#componentWillReceiveProps', () => {
    const props = { isDayBlocked() {}, isDayHighlighted() {}, isOutsideRange() {}, phrases: {} };
    ...
    describe('modifiers', () => {
        ...
        describe('props.startDate changed', () => {
          it('deleteModifier gets called with old startDate and `selected-start`', () => {
            ...
            const selectedStartCalls =
              deleteModifierSpy.getCalls().filter(call => call.args[2] === 'selected-start');
      ...
      describe('highlighted-calendar', () => {
        it.skip('calls isDayHighlighted for every visible day', () => {

        });

        it.skip('if isDayHighlighted(day) is true calls addModifier with day and `highlighted-calendar`', () => {

        });

        it.skip('if isDayHighlighted(day) is false calls deleteModifier with day and `highlighted-calendar`', () => {
      ...
      describe('today', () => {
        describe('this.today matches today', () => {
          it.skip('does not call deleteModifier with `today`', () => {

          });

          it.skip('does not call addModifier with `today`', () => {

          });
        });

        describe('this.today is no longer today', () => {
          it.skip('calls deleteModifier with this.today and `today` modifier', () => {

          });

          it.skip('calls addModifier with new today and `today` modifiers', () => {
